...
token="NTQ4NTMzNjE2NTE1MjE5NDU3.XHAbvQ.M7qUdymUa6OlmnSxt3wQv1ixP4k"
...
async def on_message(message):
    ...
    if message.author != client.user:
        ...
        if message.content.startswith("~help") and PermissionHandler().chckperms(message):
             await message.channel.send(embed=HelpCommand().sendHelpText(message.channel))
